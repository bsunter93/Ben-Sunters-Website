...
PATCHES = [  # (function, old, new) exactly as in sql/07-09, sql/13, sql/15 and sql/17
    ...
    ('ripples._render', 'st_stop := exists (', "st_stop := not coalesce((p_rounds->i->>'continues')::boolean, false) and exists ("),
]
